...
public class Competition
{
    ...
    [JsonIgnore] public string SpecializationName => GetSpecializationName();
    ...
    {
        var specialization = Repository.Instance.GetSpecializationByGuid(Specialization);
    ...
    public void UpdateData(string name, Guid specializationId, DateTime eventDate, CompetitionStatus status)
    {
        _name = name;
