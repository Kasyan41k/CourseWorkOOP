...
public class Repository
{
    ...
    public string GetSpecializationTitleByGuid(Guid specializationId)
    {

        var specialization = _specializations.FirstOrDefault(p => p.Id == specializationId);
    ...
    public List<Coach> GetCoachesBySpecializationId(Guid specializationId)
    {
        return _coaches.FindAll(c => c.SpecializationId.Equals(specializationId));
    }

    public List<SportClub> GetSportClubsBySpecializationId(Guid specializationId)
    {
        return _sportClubs.FindAll(c => c.SpecializationId.Equals(specializationId));
    }
    ...
    public List<Sportsman> GetSportsmenBySpecializationId(Guid specializationId)
    {
        return _sportsmen.FindAll(s => s.SpecializationId.Equals(specializationId));
    }
}