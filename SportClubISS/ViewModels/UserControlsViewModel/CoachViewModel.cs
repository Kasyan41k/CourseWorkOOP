...
public class CoachViewModel : BaseUserControlViewModel
{
    ...
    private void OnSelectedSpecializationCommandExecute(object p)
    {
        if(Specialization != null)
            SportClubs = _repository.GetSportClubsBySpecializationId(Specialization.Id);
    }
    ...
    public CoachViewModel() : base()
    {
        ...
        SelectedSpecializationCommand = new LambdaCommand(OnSelectedSpecializationCommandExecute, CanSelectedSpecializationCommandExecute);
    }
